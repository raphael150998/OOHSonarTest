namespace PowerPointProvider.Base
{
    ...
    public sealed class Powerpoint : IDisposable
    {
        ...
        public Powerpoint(string file, FileAccess access)
        {
            ...
            presentationDocument = PresentationDocument.Open(file, isEditable);
        }
        ...
        public Powerpoint(Stream stream, FileAccess access)
        {
            ...
            presentationDocument = PresentationDocument.Open(stream, isEditable);
        }
        ...
        public IEnumerable<PowerpointSlide> FindSlides(string note)
        {
            ...
            {
                PowerpointSlide slide = GetSlide(i);
        ...
        /// </remarks>
        public byte[] GetThumbnail(Size size = default)
        {
            byte[] thumbnail;
