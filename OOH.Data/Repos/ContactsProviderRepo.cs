...
{
    public class ContactsProviderRepo : OOHContext, IBaseRepo<ProveedoresContactos>
    {
        private readonly ILogHelper _log;
        public ContactsProviderRepo(IWebUserHelper userHelper, ILogHelper log) : base(userHelper)
        {
            _log = log;
        }
