...
{
    public class AdvertisingAgencyRepo : OOHContext, IBaseRepo<AgenciasPublicidad>
    {
        private readonly ILogHelper _log;

        public AdvertisingAgencyRepo(IWebUserHelper userHelper, ILogHelper log) : base(userHelper)
        {
            _log = log;
        }
