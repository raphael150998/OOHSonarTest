...
{
    public class CommercialRestrictionsRepo : OOHContext, IBaseRepo<RestriccionesComercialesTipos>
    {
        private readonly ILogHelper _log;

        public CommercialRestrictionsRepo(IWebUserHelper userHelper, ILogHelper log) : base(userHelper)
        {
            _log = log;
        }
